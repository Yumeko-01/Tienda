...
public class Productos {
    ...
    public String toString() {
        return "Productos{" + "nombre=" + nombre + ", tipo=" + tipo + ", cantidadBodega=" + cantidadBodega + ", cantidadMinima=" + cantidadMinima + ", valorUnitario=" + valorUnitario + ", totalProductosVendidos=" + totalProductosVendidos + '}';
    }
